    ...
    QGLWidget(parent)
{
    //showNormal();
    this->_frame_count = 0;
    this->_frame_width = 320;
    this->_frame_height = 240;
}
...
void ImageView::paintGL()
{
    ...
    DrawImage(m_texture[0], 0, 0, _frame_width, _frame_height);
    //glutSwapBuffers();
#endif
}

void ImageView::DrawImage(GLint tex, int x, int y, int w, int h)
{
...
void ImageView::AddImage(const char* frame, int w, int h, QImage::Format format)
{
    /*
...
void ImageView::buildFont() // 创建我们的字符显示列表
{
...
void ImageView::glPrint(GLint x, GLint y, char *string, int set)
{
